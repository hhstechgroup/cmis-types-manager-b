...
When the user fills 'metadataTabel-0-j_idt31' field with 'met1'
When the user fills 'metadataTabel-0-j_idt35' field with 'met1'
When the user fills 'metadataTabel-0-j_idt39' field with 'met1'
When the user fills 'metadataTabel-0-j_idt43' field with 'met1'
When the user clicks on element with xpathOrCss '//div[@id="createTypeForm-accordionPanel-metadataTabel-0-j_idt60"]/span[@class="ui-icon ui-icon-check"]'
